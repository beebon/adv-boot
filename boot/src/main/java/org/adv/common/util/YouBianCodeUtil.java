...
//			org.advframework.core.util.LogUtil.info(after_code);
//			org.advframework.core.util.LogUtil.info(after_code_zimu);
//			org.advframework.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// org.advframework.core.util.LogUtil.info(getNextZiMu('C'));
		// org.advframework.core.util.LogUtil.info(getNextNum(8));
	    // org.advframework.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
