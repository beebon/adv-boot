...

  {
    ...
    children: [
      ...
      //业务管理
      {
        ...
        redirect: '/ibizz/',
        component: PageView,
        meta: { title: '业务管理', icon: 'dashboard', permission: [ 'dashboard' ] },
        children: [
          {
            path: '/app/platform',
            name: 'platform',
            component: () => import('@/views/app/platform/AppPlatformList'),
            meta: { title: '平台管理', permission: [ 'dashboard' ] }
          },
          {
            path: '/app/task',
            name: 'task',
            component: () => import('@/views/app/task/AppTaskList'),
            meta: { title: '任务管理', permission: [ 'dashboard' ] }
          },
          {
            path: '/app/version',
            name: 'version',
            component: () => import('@/views/app/version/AppVersionList'),
            meta: { title: '版本管理', permission: [ 'dashboard' ] }
          },
          {
            path: '/app/user',
            name: 'user',
            component: () => import('@/views/app/user/AppUserList'),
            meta: { title: '应用用户管理', permission: [ 'dashboard' ] }
          },
          {
            path: '/app/device',
            name: 'user',
            component: () => import('@/views/app/device/AppUserDeviceList'),
            meta: { title: '用户设备管理', permission: [ 'dashboard' ] }
          },
          {
            path: '/app/task',
            name: 'usertask',
            component: () => import('@/views/app/task/AppUserTaskList'),
            meta: { title: '用户任务管理', permission: [ 'dashboard' ] }
          }
        ]
      },
      ...
      //adv
      {
        ...
        redirect: '/adv',
        component: RouteView,
        meta: { title: 'ADV案例', icon: 'dashboard', permission: [ 'dashboard' ] },
        children: [
          {
            path: '/adv/AdvDemoList',
            name: 'DemoList',
            component: () => import('@/views/adv/AdvDemoList'),
          ...
          },
          {
            ...
            name: 'helloworld',
            hidden : true,
            component: () => import('@/views/adv/helloworld'),
