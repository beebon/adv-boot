<template>
  <a-card :bordered="false">
    ...
    <!-- 表单区域 -->
    <advDemo-modal ref="advDemoModal" @ok="modalFormOk"></advDemo-modal>

    <!-- 一对多表单区域 -->
    <AdvDemoTabsModal ref="advDemoTabsModal" @ok="modalFormOk"></AdvDemoTabsModal>
...
<script>
  import AdvDemoModal from './modules/AdvDemoModal'
  import SuperQueryModal from './modules/SuperQueryModal'
  import AdvDemoTabsModal from './modules/AdvDemoTabsModal'
  ...
  export default {
    ...
    data() {
      return {
        ...
        selectedRows: [],
        url: {
          list: "/test/advDemo/list",
          delete: "/test/advDemo/delete",
          deleteBatch: "/test/advDemo/deleteBatch",
        },
    ...
    methods: {
      ...
      handleEdit: function (record) {
        this.$refs.advDemoModal.edit(record);
        this.$refs.advDemoModal.title = "编辑";
      },
      onetomany: function (record) {
        this.$refs.advDemoTabsModal.add();
        this.$refs.advDemoTabsModal.title = "编辑";
      },
      handleAdd: function () {
        this.$refs.advDemoModal.add();
        this.$refs.advDemoModal.title = "新增";
      },
      ...
      //跳转单据页面
      jump() {
        this.$router.push({path: '/adv/helloworld'})
      }
    }
  }
</script>
