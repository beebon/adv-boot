  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item :labelCol="labelCol" :wrapperCol="wrapperCol" label="设备操作系统">
          
          
          <a-input placeholder="请输入设备操作系统" v-decorator="['deviceSys',  {}]" />
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/app/appUserDevice/add",
          edit: "/app/appUserDevice/edit",
        },
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'userId','deviceModel','deviceSys','status','userKey','createdBy','updatedBy','createTime','updateTime'))
